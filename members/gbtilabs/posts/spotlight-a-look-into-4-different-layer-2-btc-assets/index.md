---
type: post
title: "Spotlight: A look into 4 different Layer-2 BTC assets"
slug: spotlight-a-look-into-4-different-layer-2-btc-assets
author: gbtilabs
status: published
visibility: public
...
_At the end of this article if you know about a project that was not listed here, please let us know about it in the comments below!_

## 1\. The Lightning Network

-   **Project Website**: [Lightning Network Official Site](https://lightning.network/)
...
Video by [Bitrefill](https://www.youtube.com/@Bitrefill-Crypto)

## 2\. Rootstock (RSK)

-   **Project Website**: [Rootstock Official Site](https://www.rsk.co/)
...
-   **Asset on CoinMarketCap**: [RSK Infrastructure Framework (RIF)](https://coinmarketcap.com/currencies/rsk-infrastructure-framework/)
-   **Asset on CoinGecko**: [RSK Infrastructure Framework (RIF) on CoinGecko](https://www.coingecko.com/en/coins/rsk-infrastructure-framework)
...
Video by [Rootstock](https://www.youtube.com/@Rootstock).

## 3\. Stacks

-   **Project Website**: [Stacks Official Site](https://www.stacks.co/)
...
-   **Asset on CoinMarketCap**: [Stacks (STX)](https://coinmarketcap.com/currencies/stacks/)
-   **Asset on CoinGecko**: [Stacks (STX) on CoinGecko](https://www.coingecko.com/en/coins/stacks)
...
Video provided by [Stacks](https://www.youtube.com/@Stacks-btc)

## 4\. Liquid Network

-   **Project Website**: [Liquid Network Official Site](https://blockstream.com/liquid/)
...
Video by [Blockstream](https://www.youtube.com/@Blockstream)

If you liked this content, consider following us on [Twitter/X](https://x.com/gbtilabs).
