---
type: product
title: "Radle: A WordPress Reddit Plugin"
slug: radle
author: atwellpub
status: published
visibility: public
shortDescription: "Radle is a free WordPress and Reddit plugin that replaces the default WordPress comments engine with a discussion powered by the Reddit API."
categories: ["devops", "frameworks", "wordpress"]
pricing: free
icon: "./images/radle-wordpress-plugin-icon-128x128-1.webp"
publishedAt: 2025-10-03
banner: "./images/github-product-banner-radle-wordpress-plugin.webp"
featuredImage: "./images/radle-featured.webp"
gallery:
  - "./images/radle-shot-1.webp"
  - "./images/radle-shot-2.webp"
  - "./images/radle-shot-3.webp"
  - "./images/radle-shot-4.webp"
  - "./images/radle-shot-5.webp"
  - "./images/radle-shot-6.webp"
