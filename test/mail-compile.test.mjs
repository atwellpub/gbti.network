...
import { compileWeeklyIssue, gatherContentEntries, gatherNewsEntries, listRecipientHashes } from '../workers/signup/mail-compile.mjs';
import { getIssue, readPendingIndex, getSend } from '../workers/signup/mail-store.mjs';
...
const ACTIVITY = { entries: [
  { type: 'post', slug: 'p', title: 'Public post', url: '/articles/p/', author: 'ann', publishedAt: 100, visibility: 'public' },
  { type: 'post', slug: 'm', title: 'Members stub', url: '/articles/m/', author: 'ann', publishedAt: 90, visibility: 'members' },
] };
const SHARES = { entries: [
  { type: 'share', slug: 'ann/s1', title: 'A public share', author: 'ann', url: '/shares/ann/s1/', publishedAt: 80, visibility: 'public' },
] };
const NEWS_ITEMS = [
