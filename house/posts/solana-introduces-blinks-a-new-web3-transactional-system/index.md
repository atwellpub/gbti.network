---
type: post
title: "Solana Blinks: Expanding the Accessibility of Web3"
slug: solana-introduces-blinks-a-new-web3-transactional-system
author: gbti
status: published
visibility: public
...
The Solana Foundation has introduced a transformative feature known as [Blinks](https://solana.com/news/blinks-blockchain-links-solana-actions), designed to streamline blockchain transactions and make them more accessible across the internet. This article explores what Blinks are, how they work, and the current projects utilizing this innovative technology.
...
> 
> — Chris Osborn, Founder of Dialect [source](https://solana.com/news/solana-actions-blinks-simplify-transactions-onchain)
...
> We are now supporting Blinks on [@Solana](https://twitter.com/solana?ref_src=twsrc%5Etfw)!  
>   
> Learn how to use them 🧵👇 [pic.twitter.com/ArB5D8yqeD](https://t.co/ArB5D8yqeD)
> 
> — OKX Wallet (@okxweb3) [July 5, 2024](https://twitter.com/okxweb3/status/1809254488148267121?ref_src=twsrc%5Etfw)

> Solana Actions and Blinks  
>   
> Blinks (blockchain links) enable users to engage with Tensor protocols directly from X.[@saydialect](https://twitter.com/saydialect?ref_src=twsrc%5Etfw) has built an invaluable set of developer tools to power further development for Actions and Blinks and X is just the beginning.[pic.twitter.com/mMu4qnimTG](https://t.co/mMu4qnimTG)
> 
> — Tensor Foundation (@TensorFdn) [July 2, 2024](https://twitter.com/TensorFdn/status/1808233835391603196?ref_src=twsrc%5Etfw)
...
>   
> Courtesy of [@solana](https://twitter.com/solana?ref_src=twsrc%5Etfw) and [@saydialect](https://twitter.com/saydialect?ref_src=twsrc%5Etfw)! [pic.twitter.com/Nz0aHjBACb](https://t.co/Nz0aHjBACb)
> 
> — Raydium (@RaydiumProtocol) [July 1, 2024](https://twitter.com/RaydiumProtocol/status/1807795324821405879?ref_src=twsrc%5Etfw)
...
-   [Solana Official Documentation](https://solana.com/news/solana-actions-blinks-simplify-transactions-onchain)
-   [QuickNode Guide on Solana Actions and Blinks](https://www.quicknode.com/guides/what-are-solana-actions-and-blinks)

Elon Musk, in a broader context, has shown interest in blockchain technologies and has hinted at using Rust (the programming language used by Solana) for Artificial General Intelligence (AGI) development, which indirectly brings attention to Solana due to its technical foundation in Rust. This is seen as an acknowledgment of Solana’s potential in handling high-performance tasks, which could include AI integrations​ ([SolanaFloor](https://solanafloor.com/news/ran-neuner-talks-about-elon-musk-hinting-at-solanas-biggest-use-case))​.

> Solana introduces blinks, a new primitive that transforms onchain actions into shareable links, allowing users to connect Solana to the entire internet for various activities like voting, donating, minting, swapping, and paying.[https://t.co/TXV1NEbkEG](https://t.co/TXV1NEbkEG)
> 
> — 𝙂𝘽𝙏𝙄 (@gbti\_network) [July 7, 2024](https://twitter.com/gbti_network/status/1810087384182092275?ref_src=twsrc%5Etfw)
