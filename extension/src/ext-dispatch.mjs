...
export async function dispatch(ctx, { method = 'GET', pathname, query = {}, body } = {}) {
  ...
  try {
    ...
    if (pathname === '/api/word-pool') return ok(await getWordPool(ctx)); // sow-259 (public read, same gate position as the quote pool)
